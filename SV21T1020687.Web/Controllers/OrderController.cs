...
namespace SV21T1020687.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            if (input == null)
            {
                input = new OrderSearchInput()
                {
                    ...
                    SearchValue = "",
                    Status = 0,
                    DateRange = string.Format("{0:dd/MM/yyyy} - {1:dd/MM/yyyy}", DateTime.Today.AddYears(-4), DateTime.Today)
                };
            }
            return View(input);
        }
        ...
        /// Hàm trả về chuỗi khác rỗng thông báo lỗi nếu đầu vào không hợp lệ, hàm trả về chuỗi rỗng nếu thành công.
        /// </summary>
        /// <param name="id">Mã đơn hàng</param>
        ...
        /// <param name="id">mã đơn hàng</param>
        /// <returns></returns>
        public IActionResult EditOrder(int id = 0)
        {
        ...
        public IActionResult UpdateDetail(int orderID, int productID, int Quantity, decimal salePrice)
        {
            ...
            if (!result)
            {
                return RedirectToAction("Không được phép thay đổi thông tin của đơn hàng này");
            }
            return Json("");
        }
        /// <summary>
        ...
        {
            bool result = OrderDataService.UpdateOrder(data);
        ...
        /// Hàm trả về chuỗi không rỗng thông báo lỗi nếu dữ liệu không hợp lệ,
